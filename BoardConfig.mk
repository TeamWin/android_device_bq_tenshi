...
# Kernel
TARGET_PREBUILT_KERNEL := device/bq/tenshi/kernel
TARGET_CUSTOM_KERNEL_HEADERS := device/bq/tenshi/include
...
# TWRP-Specific
TARGET_RECOVERY_FSTAB := device/bq/tenshi/recovery/etc/twrp.fstab
